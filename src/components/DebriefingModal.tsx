...
import { BookOpen, X, AlertTriangle, Sparkles, TrendingDown, Users } from 'lucide-react';
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="bg-zinc-800/80 p-3 rounded-xl border border-zinc-700/60">
              ...
              <div className="text-xl font-bold truncate" style={{ color: sortedTeams[0]?.color }}>
                {sortedTeams[0]?.name}
              </div>
            </div>
            <div className="bg-zinc-800/80 p-3 rounded-xl border border-zinc-700/60">
